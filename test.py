...
class App(ctk.CTk):
    ...
    def save_data(self):
        data = {"ip_addresses": self.ip_addresses, "scan_result": self.scan_result}
    ...
    def scan(self):
        def do_scan():
            ...
            self.scan_result = generate_scan_result()  # ...
            self.scan_result_list(self.content_frame)
            self.loading_label.destroy()
            self.scan_button.configure(state="normal")
            self.save_data()

        self.loading_label = ctk.CTkLabel(master=self.main_area, text="Scanning...")
        self.loading_label.pack()

        self.scan_button = ctk.CTkButton(
            master=self.main_area, text="Scan", command=do_scan
        )
